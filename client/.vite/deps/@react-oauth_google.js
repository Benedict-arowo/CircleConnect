import { __toESM, require_react } from "./chunk-2FATVHAI.js";

// node_modules/@react-oauth/google/dist/index.esm.js
var import_react = __toESM(require_react());
function useLoadGsiScript(options = {}) {
	const { nonce, onScriptLoadSuccess, onScriptLoadError } = options;
	const [scriptLoadedSuccessfully, setScriptLoadedSuccessfully] = (0,
	import_react.useState)(false);
	const onScriptLoadSuccessRef = (0, import_react.useRef)(
		onScriptLoadSuccess,
	);
...
function GoogleLogin({
	...
	const promptMomentNotificationRef = (0, import_react.useRef)(
		promptMomentNotification,
	);
			...
			: _c.initialize({
					...
					callback: (credentialResponse) => {
						...
						if (
							...
							credentialResponse === void 0
								? void 0
								: credentialResponse.credential)
						) {
							return (_a2 = onErrorRef.current) === null ||
								_a2 === void 0
								? void 0
								: _a2.call(onErrorRef);
						}
				...
				(_c2 =
					(_b2 =
						(_a2 =
							window === null || window === void 0
								? void 0
								: window.google) === null || _a2 === void 0
							? void 0
							: _a2.accounts) === null || _b2 === void 0
						? void 0
...
function useGoogleLogin({
			...
			(_a =
				...
				: _a.accounts.oauth2[clientMethod]({
						...
						callback: (response) => {
							...
							if (response.error)
								return (_a2 = onErrorRef.current) === null ||
									_a2 === void 0
									? void 0
									: _a2.call(onErrorRef, response);
							(_b = onSuccessRef.current) === null ||
							_b === void 0
								? void 0
						...
						error_callback: (nonOAuthError) => {
							var _a2;
							(_a2 = onNonOAuthErrorRef.current) === null ||
							_a2 === void 0
								? void 0
								: _a2.call(onNonOAuthErrorRef, nonOAuthError);
						},
						state,
						...props,
					});
	...
	const loginImplicitFlow = (0, import_react.useCallback)(
		(overrideConfig) => {
			var _a;

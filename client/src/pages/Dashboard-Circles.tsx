			...
			<div className="flex-1 w-full px-6">
              ...
              onClick={addCircle}
				...
				<div className="mt-4 border-t-2 w-full">
                  ...
                  {<ChildModal text = "Delete" onClick={DeleteCircle} text2="Delete" text3 ="Are you sure you want to delete this cirlce?" textp="This cirlce will be deleted permanently. You can't undo this action."/>}
                  
                  <button onClick={editCircle} className=" bg-transparent text-blue-700 font-light font-serif"> EDIT</button>
								</div>
							</Box>
						</Modal>
					)}

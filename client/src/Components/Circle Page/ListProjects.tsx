		...
		({
			...
			return (
				<a href={`/project/${id}`} className="cursor-pointer">
					<article
						key={id}
						className="w-[600px] relative h-[260px] flex flex-row border flex-shrink-0 border-gray-300 pt-4 pb-2 px-4 snap-normal snap-center bg-[#B9D6F0] gap-3 rounded-md drop-shadow-sm"
					>
						<div className="flex-1 w-full h-full relative flex flex-col gap-2">
							<img
							...
							<div className="flex flex-row gap-2 h-full">
								<button className="bg-blue-700 text-white px-4 py-1 rounded-md flex flex-row h-fit gap-1">
									Live Link
									<svg
								...
								<button className="text-blue-700 border border-blue-500 px-2 py-1 h-fit rounded-md text-md flex flex-row items-center gap-1">
									Github Repo
									<svg
										xmlns="http://www.w3.org/2000/svg"
										fill="none"
						...
						<div className="flex-1 relative flex flex-col justify-between">
							<div>
								...
								<p className="text-left font-normal cursor-pointer mt-1 line-clamp-4 text-neutral-800">
									{description}
								</p>

								{tags.length > 0 && (
									<div className="flex flex-row flex-wrap w-full gap-2 justify-center mt-2">

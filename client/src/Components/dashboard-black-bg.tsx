...
interface DashboardBlackBgProps {
    image: string; 
  }

 const DashboardBlackBg: React.FC<DashboardBlackBgProps> = ({ image }) => {
...
return (
    ...
    <div className="flex flex-col gap-2 mt-24 w-full">
      ...
      <div className="flex flex-row gap-4 py-1 px-2 h-fit bg-[#252525] w-full">
        ...
        <p className="font-light text-[#F1C644] text-xl">Circle</p>
      </div>
    ...
    <div className="absolute bottom-0 left-0 right-0 flex gap-2 justify-between items-center w-full p-3">
      <div className="flex flex-row gap-4 items-center">
        <section className="relative">
          <img src={image} alt={image} className="object-cover w-14 h-14" />
...
export default DashboardBlackBg;